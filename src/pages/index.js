        ...
        <Layout>
          ...
          <Container fluid>
            ...
            <Row style={{height:`100vh`}}>
              <Col sm={12} md={6} className="cleaning h-100 d-flex flex-column justify-content-center"></Col>
              <Col sm={12} md={6} style={{paddingRight: `75px`}} className="d-flex flex-column align-items-start justify-content-center">
            ...
            <Row style={{height:`100vh`}}>
              <Col sm={12} md={6} className="d-flex flex-column align-items-start justify-content-center" style={{paddingLeft: `75px`}}>
              ...
              <Col sm={12} md={6} className="repairing h-100 d-flex flex-column justify-content-center"></Col>
            </Row>
          </Container>
          {/* <h1>Hi people</h1>
